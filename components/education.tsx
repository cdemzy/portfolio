          ...
          <ul className="grid grid-cols-1 gap-10">
            ...
            >
              ...
              <span>
                ...
                {/* <ul className="list-square pl-5 ml-5">
                  <li className="text-xs italic font-normal text-gray-700 dark:text-white/75">{item.description}</li>
                  <li className="text-xs italic font-normal text-gray-700 dark:text-white/75">{item.description2}</li>
                </ul> */}
              </span>
